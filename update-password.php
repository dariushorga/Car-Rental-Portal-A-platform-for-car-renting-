...
$chngpwd1->execute();
$msg="Parola modificata cu succes";
}
else {
$error="Parola actuala este gresita";
}
}
...
{
alert("Campurile pentru parola nu coincid");
...
<form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
              <label class="control-label">Prola noua</label>
              <input class="form-control white_bg" id="newpassword" type="password" name="newpassword" required>
            </div>
            <div class="form-group">
              <label class="control-label">Confirmare parola</label>
