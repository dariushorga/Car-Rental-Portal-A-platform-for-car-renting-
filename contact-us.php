...
if($lastInsertId)
{
$msg="Formular trimis. Te vom contacta in cel mai scrut timp";
}
else 
{
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Conteacteaza-ne</h1>
        <p class="text-white">Ia legatura cu noi.</p>
      </div>
    </div>
  </div>
  <!-- Dark Overlay-->
...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        <h3>Ia legatura cu noi prin completarea acestui formular</h3>
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            <div class="form-group">
              <label class="control-label">Nume complet <span>*</span></label>
            ...
            <div class="form-group">
              <label class="control-label">Numar de telefon <span>*</span></label>
            ...
            <div class="form-group">
              <button class="btn" type="submit" name="send" type="submit">Trimite mesaj <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
