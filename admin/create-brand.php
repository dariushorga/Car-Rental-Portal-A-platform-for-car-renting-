...
if($lastInsertId)
{
$msg="Producator adaugat cu succes";
}
else
{
$error="Ceva nu a functionat cum trebuia. Incearca din nou.";
}
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Adauga Producator</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Adauga Producator</div>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>EROARE</strong>:<?php echo htmlentities($error); ?> </div><?php }
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Nume Producator</label>
												<div class="col-sm-8">
