...
$query -> execute();
$msg="Modificari realizate cu succes";
...
<head>
	...
	<title>Gestionare Abonati </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gestionare Abonati</h2>
...
<a href="manage-subscribers.php?del=<?php echo $result->id;?>" onclick="return confirm('Doresti sa stergi?');"><i class="fa fa-close"></i></a>
</td>
