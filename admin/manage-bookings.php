			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gestionare Rezervari</h2>
...
if($result->Status==0)
{
echo htmlentities('Neconfirmata');
} else if ($result->Status==1) {
echo htmlentities('Confirmata');
}
 else{
 	echo htmlentities('Respinsa');
 }
										?></td>
											<td><?php echo htmlentities($result->PostingDate);?></td>
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Vrei sa confirmi aceasta rezervare')"> Confirma</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Vrei sa respingi aceasta rezervare?')"> Respinge</a>
</td>
