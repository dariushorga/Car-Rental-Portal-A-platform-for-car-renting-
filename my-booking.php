    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Rezervarile mele</h5>
...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>Din Data:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>Pana la Data:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
                <?php if($result->Status==1)
                { ?>
                <div class="vehicle_status"> <a class="btn outline btn-xs active-btn">Confirmat</a>
                           <div class="clearfix"></div>
        </div>

              <?php } else if($result->Status==2) { ?>
 <div class="vehicle_status"> <a class="btn outline btn-xs btn-inactive">Respins</a>
            <div class="clearfix"></div>
        </div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a class="btn outline btn-xs">Inca neconfirmat</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
